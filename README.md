...
- [Central Command](https://rtcelwjnrbmfmrywacky.supabase.co/functions/v1/x402-docs) - 39-endpoint crypto trading intelligence MCP (funding rates, liquidations, counter-trade alpha, backtests, agent console). Pay-per-use x402 USDC on Base or prepaid X-Api-Key. Remote: https://rtcelwjnrbmfmrywacky.supabase.co/functions/v1/mcp ([Docs](https://rtcelwjnrbmfmrywacky.supabase.co/functions/v1/x402-docs) | [Catalog](https://rtcelwjnrbmfmrywacky.supabase.co/functions/v1/x402-gateway/catalog))
